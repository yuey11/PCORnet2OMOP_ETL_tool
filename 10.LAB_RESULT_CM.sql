...
SELECT 
	...
	CASE
	WHEN LAB_RESULT_SOURCE = 'OD' THEN 5001
	WHEN LAB_RESULT_SOURCE = 'BI' THEN 44818702
	WHEN LAB_RESULT_SOURCE = 'CL' THEN 32466
	WHEN LAB_RESULT_SOURCE = 'DR' THEN 44814649
	...
	WHEN RESULT_MODIFIER = 'TX' THEN 44814649
	...
	CASE
	WHEN RESULT_QUAL = 'POSITIVE' THEN 5001
	WHEN RESULT_QUAL = 'NEGATIVE' THEN 5001
	WHEN RESULT_QUAL = 'BORDERLINE' THEN 5001
	WHEN RESULT_QUAL = 'ELEVATED' THEN 5001
	WHEN RESULT_QUAL = 'HIGH' THEN 5001
	WHEN RESULT_QUAL = 'LOW' THEN 5001
	WHEN RESULT_QUAL = 'NORMAL' THEN 5001
	WHEN RESULT_QUAL = 'ABNORMAL' THEN 5001
	WHEN RESULT_QUAL = 'UNDETERMINED' THEN 5001
	WHEN RESULT_QUAL = 'UNDETECTABLE' THEN 5001
