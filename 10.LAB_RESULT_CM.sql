...
SELECT 
	...
	WHEN RESULT_QUAL = 'DETECTED' THEN 4126681
	WHEN RESULT_QUAL = 'EQUIVOCAL' THEN 4172976
	WHEN RESULT_QUAL = 'INDETERMINATE ABNORMAL' THEN 4219043
	WHEN RESULT_QUAL = 'INVALID' THEN 46237613
	WHEN RESULT_QUAL = 'NONREACTIVE' THEN 45884092
	WHEN RESULT_QUAL = 'NOT DETECTED' THEN 9190
	WHEN RESULT_QUAL = 'PAST INFECTION' THEN 36309657
	WHEN RESULT_QUAL = 'PRESUMPTIVE POSITIVE' THEN 36715206
	WHEN RESULT_QUAL = 'REACTIVE' THEN 45881802
	WHEN RESULT_QUAL = 'RECENT INFECTION' THEN 36307621
	WHEN RESULT_QUAL = 'SPECIMEN UNSATISFACTORY' THEN 36311004
	WHEN RESULT_QUAL = 'SUSPECTED' THEN 45884696																	      
...
/*Insert the specimen_concept_id*/
UPDATE OMOP.dbo.specimen
SET specimen_concept_id = 
CASE
		WHEN specimen_source_value = '^BPU' THEN 4001346
	WHEN specimen_source_value = '^EMBRYO' THEN 42605994
	WHEN specimen_source_value = '^FETUS' THEN 4202977
	WHEN specimen_source_value = '^MUSHROOM_SPECIMEN' THEN 4002736
	WHEN specimen_source_value = '^PATIENT' THEN 4001345
	WHEN specimen_source_value = '^PLANT_SPECIMEN' THEN 4000612
	WHEN specimen_source_value = '^SPECIMEN' THEN 4048506
	WHEN specimen_source_value = '^TICK' THEN 46271815
	WHEN specimen_source_value = 'ABSCESS' THEN 4001183
	WHEN specimen_source_value = 'ADRENAL_GLAND' THEN 4204948
	WHEN specimen_source_value = 'AIR' THEN 40487357
	WHEN specimen_source_value = 'AMNIO_FLD' THEN 4002223
	WHEN specimen_source_value = 'ANAL' THEN 4204349
	WHEN specimen_source_value = 'AORTA.ROOT' THEN 42535844
	WHEN specimen_source_value = 'BARTHOLIN_CYST' THEN 43021092
	WHEN specimen_source_value = 'BBL' THEN 4001347
	WHEN specimen_source_value = 'BLD' THEN 4001225
	WHEN specimen_source_value = 'BLD^BPU' THEN 4001346
	WHEN specimen_source_value = 'BLD^CONTROL' THEN 4046276
	WHEN specimen_source_value = 'BLD^DONOR' THEN 4047497
	WHEN specimen_source_value = 'BLD^PATIENT' THEN 4046277
	WHEN specimen_source_value = 'BLD_BONE_MAR' THEN 4000623
	WHEN specimen_source_value = 'BLDA' THEN 4047496
	WHEN specimen_source_value = 'BLDC' THEN 4046834
	WHEN specimen_source_value = 'BLDCO' THEN 4046835
	WHEN specimen_source_value = 'BLDCOA' THEN 45766301
	WHEN specimen_source_value = 'BLDCOV' THEN 45766302
	WHEN specimen_source_value = 'BLDMV' THEN 4001226
	WHEN specimen_source_value = 'BLDP' THEN 4047495
	WHEN specimen_source_value = 'BLDV' THEN 4045667
	WHEN specimen_source_value = 'BODY_FLD' THEN 4204181
	WHEN specimen_source_value = 'BONE' THEN 4123176
	WHEN specimen_source_value = 'BONE_MAR' THEN 4000623
	WHEN specimen_source_value = 'BONE_MARROW' THEN 4000623
	WHEN specimen_source_value = 'BRAIN' THEN 4002227
	WHEN specimen_source_value = 'BREAST' THEN 4132242
	WHEN specimen_source_value = 'BRONCHIAL' THEN 4206409
	WHEN specimen_source_value = 'BUCCAL_SMEAR' THEN 4120353
	WHEN specimen_source_value = 'BURN' THEN 4123177
	WHEN specimen_source_value = 'CALCULUS' THEN 4001065
	WHEN specimen_source_value = 'CELLS.XXX' THEN 44806863
	WHEN specimen_source_value = 'CHEESE' THEN 42605987
	WHEN specimen_source_value = 'CNJT' THEN 4000637
	WHEN specimen_source_value = 'CNL' THEN 4002870
	WHEN specimen_source_value = 'COL' THEN 4002874
	WHEN specimen_source_value = 'COLON' THEN 4002892
	WHEN specimen_source_value = 'CONTACT_LENS' THEN 4207128
	WHEN specimen_source_value = 'CRN' THEN 4000636
	WHEN specimen_source_value = 'CSF' THEN 4124259
	WHEN specimen_source_value = 'CSF.SPUN' THEN 45773106
	WHEN specimen_source_value = 'CTP' THEN 4001350
	WHEN specimen_source_value = 'CVM' THEN 4046281
	WHEN specimen_source_value = 'CVX_VAG' THEN 45765695
	WHEN specimen_source_value = 'DAIRY_PRODUCT' THEN 42606009
	WHEN specimen_source_value = 'DENTIN' THEN 4001358
	WHEN specimen_source_value = 'DIAL_FLD' THEN 4000624
	WHEN specimen_source_value = 'DIAL_FLD_PRT' THEN 4045763
	WHEN specimen_source_value = 'DUOD_FLD' THEN 4046839
	WHEN specimen_source_value = 'EAR' THEN 4204951
	WHEN specimen_source_value = 'EAR_FLUID' THEN 37116371
	WHEN specimen_source_value = 'EGG' THEN 42573743
	WHEN specimen_source_value = 'EGGYLK' THEN 4002220
	WHEN specimen_source_value = 'ENDOCERVICAL_BRUSH' THEN 36713736
	WHEN specimen_source_value = 'ENDOMET' THEN 4002226
	WHEN specimen_source_value = 'ENVIR' THEN 4206699
	WHEN specimen_source_value = 'ENVIRONMENTAL_SPECIMEN' THEN 4206699
	WHEN specimen_source_value = 'ESOPHAGEAL_BRUSH' THEN 36713736
	WHEN specimen_source_value = 'EXHL_GAS' THEN 4001357
	WHEN specimen_source_value = 'EXUDATE' THEN 4122250
	WHEN specimen_source_value = 'EYE' THEN 4001190
	WHEN specimen_source_value = 'FEATHER' THEN 42605999
	WHEN specimen_source_value = 'FIBROBLASTS' THEN 4001356
	WHEN specimen_source_value = 'FLU.NONBIOLOGICAL' THEN 4001351
	WHEN specimen_source_value = 'FOOD' THEN 4000616
	WHEN specimen_source_value = 'GAST_FLD' THEN 4120336
	WHEN specimen_source_value = 'GENITAL' THEN 4001063
	WHEN specimen_source_value = 'GENITAL_FLD' THEN 46270237
	WHEN specimen_source_value = 'GENITAL_LOC' THEN 4048850
	WHEN specimen_source_value = 'GENITAL_MUC' THEN 4046840
	WHEN specimen_source_value = 'HAIR' THEN 4001355
	WHEN specimen_source_value = 'INHL_GAS' THEN 4002878
	WHEN specimen_source_value = 'KIDNEY' THEN 4133742
	WHEN specimen_source_value = 'LIVER' THEN 4002224
	WHEN specimen_source_value = 'LUNG' THEN 4133172
	WHEN specimen_source_value = 'LUNG_TISS' THEN 4164332
	WHEN specimen_source_value = 'LYMPH_NODE' THEN 4124291
	WHEN specimen_source_value = 'MECONIUM' THEN 4001060
	WHEN specimen_source_value = 'MILK' THEN 4001058
	WHEN specimen_source_value = 'MLK.RAW' THEN 42606004
	WHEN specimen_source_value = 'MOUTH' THEN 4204956
	WHEN specimen_source_value = 'MUSCLE' THEN 45767596
	WHEN specimen_source_value = 'NAIL' THEN 4000618
	WHEN specimen_source_value = 'NASAL_FLUID' THEN 4057744
	WHEN specimen_source_value = 'NIPPLE_DISCHARGE' THEN 4202978
	WHEN specimen_source_value = 'NOSE' THEN 40491357
	WHEN specimen_source_value = 'NPH' THEN 42539412
	WHEN specimen_source_value = 'OVARY' THEN 4027387
	WHEN specimen_source_value = 'PANCREAS' THEN 4133175
	WHEN specimen_source_value = 'PENIS' THEN 4002896
	WHEN specimen_source_value = 'PERITONEUM' THEN 4325355
	WHEN specimen_source_value = 'PHARYNX' THEN 4332381
	WHEN specimen_source_value = 'PLACENTA' THEN 4001192
	WHEN specimen_source_value = 'PLANT' THEN 4000612
	WHEN specimen_source_value = 'PLAS' THEN 4000626
	WHEN specimen_source_value = 'PLATELETS' THEN 4001179
	WHEN specimen_source_value = 'PLEURA' THEN 4133739
	WHEN specimen_source_value = 'PLR_FLD' THEN 4302933
	WHEN specimen_source_value = 'PPP' THEN 4000627
	WHEN specimen_source_value = 'PPP^CONTROL' THEN 4046842
	WHEN specimen_source_value = 'PPP^POOL' THEN 42537788
	WHEN specimen_source_value = 'PREPUTIAL_WASH' THEN 42606035
	WHEN specimen_source_value = 'PROSTATE' THEN 4001186
	WHEN specimen_source_value = 'PROSTATIC_FLD' THEN 4119384
	WHEN specimen_source_value = 'PRP' THEN 4001180
	WHEN specimen_source_value = 'PRP^CONTROL' THEN 4046842
	WHEN specimen_source_value = 'PUS' THEN 4000617
	WHEN specimen_source_value = 'RECTUM' THEN 40487491
	WHEN specimen_source_value = 'RESPIRATORY' THEN 4119536
	WHEN specimen_source_value = 'RESPIRATORY.LOWER' THEN 4119538
	WHEN specimen_source_value = 'RESPIRATORY.UPPER' THEN 4119537
	WHEN specimen_source_value = 'SALIVA' THEN 4001062
	WHEN specimen_source_value = 'SEMEN' THEN 44808818
	WHEN specimen_source_value = 'SER' THEN 4001181
	WHEN specimen_source_value = 'SER^CONTROL' THEN 42539680
	WHEN specimen_source_value = 'SER^DONOR' THEN 4048853
	WHEN specimen_source_value = 'SER_PLAS_BLD' THEN 37303842
	WHEN specimen_source_value = 'SKIN' THEN 43531265
	WHEN specimen_source_value = 'SOFT_TISSUE.FNA' THEN 4205805
	WHEN specimen_source_value = 'SPECIMEN' THEN 4048506
	WHEN specimen_source_value = 'SPERMATOZOA' THEN 4002882
	WHEN specimen_source_value = 'SPLEEN' THEN 4336060
	WHEN specimen_source_value = 'SPTT' THEN 4122289
	WHEN specimen_source_value = 'SPUTUM' THEN 4002876
	WHEN specimen_source_value = 'STOMACH' THEN 4002891
	WHEN specimen_source_value = 'STOOL' THEN 4002879
	WHEN specimen_source_value = 'SWEAT' THEN 4046838
	WHEN specimen_source_value = 'SYNV_FLD' THEN 4002875
	WHEN specimen_source_value = 'TEAR' THEN 4046369
	WHEN specimen_source_value = 'TESTIS' THEN 4134447
	WHEN specimen_source_value = 'THYROID' THEN 4164619
	WHEN specimen_source_value = 'TRAC' THEN 4002894
	WHEN specimen_source_value = 'TRACHEAL_SWAB' THEN 42573143
	WHEN specimen_source_value = 'TSMI' THEN 4046380
	WHEN specimen_source_value = 'TUMOR' THEN 4122248
	WHEN specimen_source_value = 'ULC' THEN 4000629
	WHEN specimen_source_value = 'URETHRA' THEN 4001188
	WHEN specimen_source_value = 'URINARY_BLADDER' THEN 42872877
	WHEN specimen_source_value = 'URINE' THEN 4046280
	WHEN specimen_source_value = 'URINE_SED' THEN 4045758
	WHEN specimen_source_value = 'UTERUS' THEN 4133745
	WHEN specimen_source_value = 'VAG' THEN 4001189
	WHEN specimen_source_value = 'VOMITUS' THEN 4045760
	WHEN specimen_source_value = 'WATER' THEN 4001352
	WHEN specimen_source_value = 'WBC' THEN 4122287
	WHEN specimen_source_value = 'WHEY' THEN 764638
	WHEN specimen_source_value = 'WOUND' THEN 4002221
	WHEN specimen_source_value = 'WOUND.DEEP' THEN 46270190
	WHEN specimen_source_value = 'XXX.BODY_FLUID' THEN 4204181
	WHEN specimen_source_value = 'XXX.SWAB' THEN 4120698
	WHEN specimen_source_value = 'NI' THEN 44814650
	WHEN specimen_source_value = 'UN' THEN 44814653
	WHEN specimen_source_value = 'OT' THEN 44814649 
	ELSE 0 END
	;
