...
SELECT 
	...
	CASE
	WHEN CONDITION_SOURCE = 'PR' THEN 32865
	WHEN CONDITION_SOURCE = 'HC' THEN 32840
	WHEN CONDITION_SOURCE = 'RG' THEN 32879
	WHEN CONDITION_SOURCE = 'PC' THEN 32880
	WHEN CONDITION_SOURCE = 'DR' THEN 45754907
	...
	WHEN CONDITION_STATUS = 'RS' THEN 32906
