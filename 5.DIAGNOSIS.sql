...
SELECT 
	...
	CASE
	WHEN DX_ORIGIN = 'OD' THEN 32020
	WHEN DX_ORIGIN = 'BI' THEN 32019
	WHEN DX_ORIGIN = 'CL' THEN 45756835
	WHEN DX_ORIGIN = 'DR' THEN 32424
	...
	CASE
	WHEN DX_SOURCE = 'AD' THEN 4203942
	WHEN DX_SOURCE = 'DI' THEN 4230359
	WHEN DX_SOURCE = 'FI' THEN 4230359
	WHEN DX_SOURCE = 'IN' THEN 4220300
