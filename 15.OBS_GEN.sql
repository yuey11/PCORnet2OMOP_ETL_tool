...
SELECT 
	...
	CASE
	WHEN OBSGEN_SOURCE = 'OD' THEN 32817
	WHEN OBSGEN_SOURCE = 'BI' THEN 32821
	WHEN OBSGEN_SOURCE = 'CL' THEN 32810
	WHEN OBSGEN_SOURCE = 'RG' THEN 32879
	WHEN OBSGEN_SOURCE = 'DR' THEN 45754907
