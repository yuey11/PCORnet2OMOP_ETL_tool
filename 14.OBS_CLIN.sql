...
SELECT 
	...
	CASE
	WHEN OBSCLIN_SOURCE = 'OD' THEN 32817
	WHEN OBSCLIN_SOURCE = 'BI' THEN 32821
	WHEN OBSCLIN_SOURCE = 'CL' THEN 32810
	WHEN OBSCLIN_SOURCE = 'RG' THEN 32879
	WHEN OBSCLIN_SOURCE = 'DR' THEN 45754907
