/*This file used to transform PCORnet OBS_CLIN table into the OMOP observation table.*/
...
SELECT 
	...
	cast(OBSCLIN_DATE as date),

	CASE
	WHEN OBSCLIN_DATE IS NULL THEN '1900-01-01 00:00:00.000'
	WHEN OBSCLIN_DATE IS NOT NULL AND OBSCLIN_TIME IS NULL THEN OBSCLIN_DATE	
	WHEN OBSCLIN_DATE IS NOT NULL AND OBSCLIN_TIME IS NOT NULL THEN CONVERT(datetime, CONVERT(char(8),cast(OBSCLIN_DATE as date),112)+ ' ' + CONVERT(char(8),cast(OBSCLIN_TIME as time),108)) END,

	CASE
	WHEN OBSCLIN_SOURCE = 'OD' THEN 38000280
	WHEN OBSCLIN_SOURCE = 'BI' THEN 38000280
	WHEN OBSCLIN_SOURCE = 'CL' THEN 32467
	WHEN OBSCLIN_SOURCE = 'RG' THEN 38000280
	WHEN OBSCLIN_SOURCE = 'DR' THEN 32445
	WHEN OBSCLIN_SOURCE = 'NI' THEN 44814650
	WHEN OBSCLIN_SOURCE = 'UN' THEN 44814653
	WHEN OBSCLIN_SOURCE = 'OT' THEN 44814649 
	WHEN OBSCLIN_SOURCE = '' THEN 44814653
	WHEN OBSCLIN_SOURCE is null THEN 44814653 END,
	...
	CASE
	WHEN OBSCLIN_RESULT_QUAL = 'POSITIVE' THEN 9191
	WHEN OBSCLIN_RESULT_QUAL = 'NEGATIVE' THEN 9189
	WHEN OBSCLIN_RESULT_QUAL = 'BORDERLINE' THEN 4162852
	WHEN OBSCLIN_RESULT_QUAL = 'ELEVATED' THEN 4328749
	WHEN OBSCLIN_RESULT_QUAL = 'HIGH' THEN 4328749
	WHEN OBSCLIN_RESULT_QUAL = 'LOW' THEN 4267416
	WHEN OBSCLIN_RESULT_QUAL = 'NORMAL' THEN 4124457
	WHEN OBSCLIN_RESULT_QUAL = 'ABNORMAL' THEN 4183448
	WHEN OBSCLIN_RESULT_QUAL = 'UNDETERMINED' THEN 4160775
	WHEN OBSCLIN_RESULT_QUAL = 'UNDETECTABLE' THEN 44814653
	WHEN OBSCLIN_RESULT_QUAL = 'NI' THEN 44814650
	WHEN OBSCLIN_RESULT_QUAL = 'UN' THEN 44814653
	WHEN OBSCLIN_RESULT_QUAL = 'OT' THEN 44814649
	WHEN OBSCLIN_RESULT_QUAL = '' THEN 44814653 END,
	...
	WHEN OBSCLIN_RESULT_QUAL = 'UNDETERMINED' THEN 4160775
	WHEN OBSCLIN_RESULT_QUAL = 'UNDETECTABLE' THEN 44814653
	WHEN OBSCLIN_RESULT_MODIFIER = 'EQ' THEN 4172703
	WHEN OBSCLIN_RESULT_MODIFIER = 'GE' THEN 4171755
	WHEN OBSCLIN_RESULT_MODIFIER = 'GT' THEN 4172704
	WHEN OBSCLIN_RESULT_MODIFIER = 'LE' THEN 4171754
	WHEN OBSCLIN_RESULT_MODIFIER = 'LT' THEN 4171756
	WHEN OBSCLIN_RESULT_MODIFIER = 'TX' THEN 44814649
	WHEN OBSCLIN_RESULT_QUAL = 'NI' THEN 44814650
	WHEN OBSCLIN_RESULT_QUAL = 'UN' THEN 44814653
	WHEN OBSCLIN_RESULT_QUAL = 'OT' THEN 44814649
	WHEN OBSCLIN_RESULT_QUAL = '' THEN 44814653 END,
	...
	CASE 
	WHEN OBSCLIN_RESULT_SNOMED IS NOT NULL THEN OBSCLIN_RESULT_SNOMED
	ELSE OBSCLIN_CODE END,
	...
	CASE 
	WHEN OBSCLIN_RESULT_QUAL IS NOT NULL THEN OBSCLIN_RESULT_QUAL
	WHEN OBSCLIN_RESULT_MODIFIER IS NOT NULL THEN OBSCLIN_RESULT_MODIFIER END,

	0

	FROM PCORnet.dbo.OBS_CLIN a  
	LEFT JOIN OMOP.dbo.person b
	ON a.PATID = b.person_source_value
	LEFT JOIN OMOP.dbo.provider c
	ON a.OBSCLIN_PROVIDERID = c.provider_source_value
